    ...
    <div className="overflow-hidden w-full h-full max-w-sm mx-auto relative group">
      <Link to={`/product/${product._id}`} className="block">
        <i
          ...
          className="ri-shopping-bag-line absolute top-2 right-4 text-lg text-black bg-white rounded-full px-2 py-1 shadow-sm cursor-pointer opacity-0 group-hover:opacity-100 transform translate-x-full group-hover:translate-x-0 transition-all duration-300"
        ></i>

        <i
          onClick={handleWishlistClick}
          className={`ri-heart-${isInWishlist ? "fill text-red-500" : "line"} absolute top-12 right-4 text-lg bg-white rounded-full px-2 py-1 shadow-sm cursor-pointer opacity-0 group-hover:opacity-100 transform translate-x-full group-hover:translate-x-0 transition-all duration-300`}
        ></i>
